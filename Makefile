...
# Source files
SOURCES = darklands.cpp Catalog.cpp CityFile.cpp CityLabels.cpp FontFile.cpp GameData.cpp LocationFile.cpp MapFile.cpp Palette.cpp PICImage.cpp TextSupport.cpp WorldMap.cpp
