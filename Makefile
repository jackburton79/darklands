...
# Source files
SOURCES = darklands.cpp Catalog.cpp CityFile.cpp CityLabels.cpp FontFile.cpp GameData.cpp LocationFile.cpp MapFile.cpp MapViewer.cpp MsgFile.cpp Palette.cpp PICImage.cpp TextSupport.cpp Travel.cpp WorldMap.cpp
